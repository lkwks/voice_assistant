...
export const isCapitalized = function(str) {
    return /^[A-Z][a-z].*/.test(str) || isNumber(str);
}

// Start with opening quotes or capitalized letter
export const isSentenceStarter = function(str) {
    return isCapitalized(str) || /``|"|'/.test(str.substring(0,2));
}

export const isCommonAbbreviation = function(str) {
...
export const isTimeAbbreviation = function(word, next) {
...
export const isDottedAbbreviation = function(word) {
...
export const isCustomAbbreviation = function(str) {
    if (str.length <= 3) {
        return true;
    }
...
export const isNumber = function(str, dotPos) {
    if (dotPos) {
...
export const isPhoneNr = function(str) {
...
export const isConcatenated = function(word) {
    var i = 0;
...
export const isBoundaryChar = function(word) {
    return word === "." ||
           word === "!" ||
           word === "?";
};
